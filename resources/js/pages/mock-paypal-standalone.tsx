            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 flex items-center justify-center p-4">
                <Card className="w-full max-w-md shadow-2xl">
                    <CardContent className="text-center py-12">
                        ...
                        <p className="mt-4 text-gray-600">Loading PayPal checkout...</p>
                    </CardContent>
                </Card>
            </div>
        );
        ...
        <Card className="w-full max-w-md shadow-2xl">
            ...
            <CardContent>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-2xl font-bold text-blue-900">${data.amount.toFixed(2)} USD</p>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-lg font-semibold pt-3 border-t border-gray-200">
                            ...
                            <span className="text-green-600">${data.amount.toFixed(2)} USD</span>
                        </div>
                    </div>
                </div>
    ...
    const renderProcessingStep = () => (
        <Card className="w-full max-w-md shadow-2xl">
            <CardContent className="text-center py-12">
                ...
                <p className="text-gray-600">Please wait while we process your payment of ${data.amount.toFixed(2)}</p>
            </CardContent>
        </Card>
    );
    ...
    const renderSuccessStep = () => (
        <Card className="w-full max-w-md shadow-2xl">
            <CardContent className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Your payment of ${data.amount.toFixed(2)} has been processed</p>
